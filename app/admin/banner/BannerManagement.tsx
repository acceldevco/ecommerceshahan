...
//                 className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
//               >
//                 <option value="TOP">اسلایدر</option>
//                 <option value="MIDDLE">میانی</option>
//                 <option value="RIGHT">راست</option>
//                 <option value="LEFT">چپ</option>
//                 <option value="BOTTOM">فوتر</option>
//               </select>
//             </div>
...
type BannerFormData = {
  ...
  image: string;
  link: string;
  position: "TOP" | "MIDDLE" | "RIGHT" | "LEFT" | "BOTTOM";
  status: boolean;
};
...
export default function BannerManagement() {
  ...
  const handleEdit = (banner: Banner) => {
    ...
    reset({
      ...
      link: banner.link,
      position: banner.position as BannerFormData["position"],
      ...
      >
        <div className="max-w-7xl mx-auto">
            ...
            {banners.map((banner) => (
              ...
              >
                <div className="relative">
                  ...
                  />
                  <div
                    className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-medium ${banner.isActive
                        ? "bg-green-500 text-white"
                        : "bg-gray-500 text-white"
                      }`}
                  >
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2 pt-4 border-t border-gray-100">
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all ${banner.isActive
                          ? "bg-amber-50 text-amber-700 hover:bg-amber-100"
                          : "bg-green-50 text-green-700 hover:bg-green-100"
                        }`}
                    >
          ...
          <div>
            {hasMore && (
              <button
                className="px-6 py-2 text-white m-5 rounded-lg bg-[#777C6D] transition-all shadow-lg flex items-center gap-2 font-semibold"
                onClick={() => loadMore()}
              >
                نمایش بیشتر
              </button>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <button
                ...
                className="w-full mb-2 flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-4 py-3 rounded-xl hover:bg-gray-200 transition-all"
              >
                <Plus size={20} />
                انتخاب تصویر
              </button>
