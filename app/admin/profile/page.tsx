...
export default function EditProfile() {
  ...
  const [newAddress, setNewAddress]:any = useState({
    title: '',
    address: '',
    postalCode: '',
    city: 'تهران',
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm border border-[#e8e8e0] p-6">
              ...
              <nav className="space-y-2">
                ...
                <Link href="/orders" className="block w-full text-right px-4 py-3 rounded-xl text-[#8a8b7a] hover:bg-[#f8f8f5] hover:text-[#5a5b4a] transition-all duration-300">
                  <div className="flex items-center">
                    <svg className="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewAddress((prev:any) => ({ ...prev, title: e.target.value }))}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewAddress((prev:any) => ({ ...prev, postalCode: e.target.value }))}
                        placeholder="۱۰ رقمی"
                        className="w-full px-3 py-2.5 border border-[#e8e8e0] rounded-lg focus:ring-2 focus:ring-[#b7b89e] focus:border-[#b7b89e] transition-all bg-[#fafaf8]"
                      />
                    </div>
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setNewAddress((prev:any) => ({ ...prev, province: e.target.value }))}
                        className="w-full px-3 py-2.5 border border-[#e8e8e0] rounded-lg focus:ring-2 focus:ring-[#b7b89e] focus:border-[#b7b89e] transition-all bg-[#fafaf8]"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setNewAddress((prev:any) => ({ ...prev, city: e.target.value }))}
                        className="w-full px-3 py-2.5 border border-[#e8e8e0] rounded-lg focus:ring-2 focus:ring-[#b7b89e] focus:border-[#b7b89e] transition-all bg-[#fafaf8]"
                      >
                        <option value="تهران">تهران</option>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        onChange={(e) => setNewAddress((prev:any) => ({ ...prev, address: e.target.value }))}
                        // rows="3"
